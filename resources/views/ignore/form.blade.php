...
@section('content')
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            {!! Form::open(['route' => isset($update) ? ['ignore.update', $model->id] :'ignore.store', 'method' => 'post', 'files'=>true]) !!}
                <!-- Default box -->
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            {!! Form::label('word', 'Kata Yang Diabaikan') !!}
                            {!! Form::text('word', $model->word, ['class'=>'form-control','required']) !!}
                        </div>
                        <div class="form-group">
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn btn-default" onclick="window.location='<?= route('ignore.manage') ?>'">Back</button>
